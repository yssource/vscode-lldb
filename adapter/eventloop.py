...
class EventLoop:
    ...
    def dispatch(self, target, args): # type: (EventLoop, Callable[[Sequence[Any]], None], Sequence[Any]) -> None
        '''Dispatch to function with a tuple of arguments'''
        self.queue.put((target, args))

    def dispatch1(self, target, arg): # type: (EventLoop, Callable[[Any], None], Any) -> None
